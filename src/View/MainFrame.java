...
//		verticalBox.add(rdbtnNewRadioButton_3);
		...
		JCheckBox chckbxHypernyms = new JCheckBox("Hypernyms");
		...
		slider_1.setAlignmentX(Component.RIGHT_ALIGNMENT);
		slider_1.setEnabled(false);
		horizontalBox_3.add(slider_1);
		slider_1.setValue(0);
		...
		JCheckBox chckbxSynonyms = new JCheckBox("Synonyms");
	  ...
	  class SortTableModel extends DefaultTableModel {
		  ...
		  class ColumnListener extends MouseAdapter {
		    ...
		    public void mouseClicked(MouseEvent e) {
		      ...
		      Vector tempVector = (Vector) model.getDataVector().clone();
