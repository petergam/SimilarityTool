...
public class ArticleManager {
	...
	public Article getArticleFromFile(File file) {
		...
		try {
			//Load file into string
		      ...
		      HashMap<String, Integer> wordsHashMap = this.getHashMapFromArrayList(wordsArray);
	...
	public HashMap<String, Integer> getHashMapFromArrayList(ArrayList<String> arrayList) {
